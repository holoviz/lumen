const appName = 'Lumen'
const appCacheName = 'Lumen-0.7.0';

const preCacheFiles = [];

const cachePatterns = ['https://cdn.holoviz.org/panel/1.6.0/dist/', 'https://cdn.bokeh.org/bokeh/', 'https://cdn.jsdelivr.net/pyodide/', 'https://files.pythonhosted.org/packages/', 'https://pypi.org/pypi/'];
