...
async function loadApplication(cell_id, path) {
  ...
  const packages = ['https://cdn.holoviz.org/panel/1.3.4/dist/wheels/bokeh-3.3.2-py3-none-any.whl', 'https://cdn.holoviz.org/panel/1.3.4/dist/wheels/panel-1.3.4-py3-none-any.whl', 'lumen==0.6.1', 'requests', 'pandas', 'pyodide-http', 'holoviews>=1.15.1'];
  if (path != null) {
