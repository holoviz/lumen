...
async function loadApplication(cell_id, path) {
  ...
  const packages = ['https://cdn.holoviz.org/panel/1.7.0-a.1/dist/wheels/bokeh-3.7.3-py3-none-any.whl', 'https://cdn.holoviz.org/panel/1.7.0-a.1/dist/wheels/panel-1.7.0a1-py3-none-any.whl', 'lumen==0.10.0', 'requests', 'pandas', 'pyodide-http', 'holoviews>=1.15.1'];
  if (path != null) {
