...
async function loadApplication(cell_id, path) {
  ...
  const packages = ['https://cdn.holoviz.org/panel/1.6.0/dist/wheels/bokeh-3.6.2-py3-none-any.whl', 'https://cdn.holoviz.org/panel/1.6.0/dist/wheels/panel-1.6.0-py3-none-any.whl', 'lumen==0.7.0', 'requests', 'pandas', 'pyodide-http', 'holoviews>=1.15.1'];
  if (path != null) {
