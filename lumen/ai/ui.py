...
from .agents import (
    AnalysisAgent, ChatAgent, DeckGLAgent, DocumentListAgent, SQLAgent,
...
class UI(Viewer):
    ...
    default_agents = param.List(default=[
        TableListAgent, ChatAgent, DocumentListAgent, SQLAgent, VegaLiteAgent, DeckGLAgent, ValidationAgent
